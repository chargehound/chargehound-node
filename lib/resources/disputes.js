...
module.exports = class Disputes {
   ...
   * You will want to submit the dispute through Chargehound after you recieve a webhook notification of a new dispute. With one `POST` request you can update a dispute with the evidence fields and submit the generated response. The response will have a `201` status if the submit was successful. The dispute will also be in the submitted state.
   * @param {String}  disputeId A dispute id
