...
module.exports = class Disputes {
   ...
   * @param {String} [disputeUpdate.customer_name] Update the customer name. Will also update the customer name in the evidence fields.
   * @param {String} [disputeUpdate.customer_email] Update the customer email. Will also update the customer email in the evidence fields. Must be a valid email address.
   * @param {function} [callback] the callback function
   * @return Dispute
   */
